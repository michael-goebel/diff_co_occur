...
"""
This script defines the differentiable histogram function, along with some more basic and brute force checks.
Running this script directly will execute these tests.
"""
