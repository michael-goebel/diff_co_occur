...
class Resize:
	def __init__(self,L): self.L = L
	def __str__(self): return f'Resize {self.L}x{self.L}'
	def __call__(self,X): return cv2.resize(X,(self.L,self.L))
...
if __name__=='__main__':
	...
	f_list = [Identity(), RandomCrop(256), CenterCrop(256), CenterCrop(384), Resize(256),
