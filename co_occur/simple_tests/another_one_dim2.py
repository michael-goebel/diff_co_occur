...
#params_list = [[hist_loss_L1, 1, 'L1'], [hist_loss_L2, 1, 'L2'], [hist_loss_L1, 3, 'L1 Pyramid'], [hist_loss_L2, 3, 'L2 Pyramid']]
...
for (loss_func, n_layers, name), ax in zip(params_list,axes.T):
	...
	for i in range(N):
		...
		ax[i].plot([0,0],[y_max+0.5,-0.5],':',color='#808080')
		ax[i].plot([3,3],[y_max+0.5,-0.5],':',color='#808080')
